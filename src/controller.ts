...
// import { chargingStations } from "./charging_station";
...
// function rankAmenities(amenities: Amenity[], chargingStations: Amenity[]):Amenity[] {
...
// function calculateRatingBasedScore(amenities:Amenity[]):Amenity[] {
//     return amenities.map(amenity => {
...
// function filterPlaces(places: Amenity[]) {
...
// const resamenities=calculateRatingBasedScore(amenities);
// const result_=rankAmenities(resamenities, chargingStations);
// console.log(filterPlaces(result_));
